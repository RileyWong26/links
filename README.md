...
| Name | Link | Description |
| ----------- | ----------- | ------|
| ML From Scratch | [Link](https://github.com/eriklindernoren/ML-From-Scratch) | Teaches fundamentals of ML |

## Opensource
| Name | Link | Description |
| ----------- | ----------- | ------|
| Good First Issue | [Link](https://goodfirstissue.dev/) | A list of open source projects that are looking for contributions.  Designed to help find a project for you to make your first contribution. |
